...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { email: @candidate.email, hired: @candidate.hired, name: @candidate.name } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { email: @candidate.email, hired: @candidate.hired, name: @candidate.name } }
